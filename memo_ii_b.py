...
base_seed=270426
pointingerrs=[pointing_family(base_pointing_error,5,seed=base_seed),
              pointing_family(base_pointing_error,2,seed=base_seed+1),
              pointing_family(base_pointing_error,4,seed=base_seed+2),
              pointing_family(base_pointing_error,3,seed=base_seed+3),
              pointing_family(base_pointing_error,1,seed=base_seed+4),]
...
power_comparison_plots(redo_window_calc=False, redo_box_calc=False, alr_imp_CST=True,
                       ...
                       frac_tol_conv=0.05, categ="PA-CST",             # categ is PA/CST/PA-CST-pointingonly/PA-CST-general, beam_type is either Gaussian (for PA) or manual (for CST) # frac_tol_conv=0.005 for Fir
